...
type dateTimePicker =
    ...
    static member inline dateRangeIcon (value: ReactElement) = Interop.mkAttr "dateRangeIcon" value
    ...
    /// Time tab icon
    static member inline timeIcon (value: ReactElement) = Interop.mkAttr "timeIcon" value
