...
let project = "Feliz.MaterialUI.Pickers"
...
Target.create "CopyDocFiles" <| fun _ ->
    [ pub @@ "Pickers/README.md", __SOURCE_DIRECTORY__ @@ "README.md"
      pub @@ "Pickers/RELEASE_NOTES.md", __SOURCE_DIRECTORY__ @@ "RELEASE_NOTES.md"
...
Target.create "PackageJson" <| fun _ ->
    let setValues (current: Json.JsonPackage) =
        { current with
            ...
            Bugs = 
                { Json.BugsValue.Url = 
                    @"https://github.com/Shmew/Feliz.MaterialUI.Pickers/issues/new/choose" |> Some } |> Some
            License = "MIT" |> Some
            Author = author |> Some
            Private = true |> Some }
